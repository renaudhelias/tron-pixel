...
int line=10;
    for( int iPathNode = 0; iPathNode < pathNodeCount; iPathNode++ ) {
      MetaPostPath mpp = new MetaPostPath(line, pathNodes.item( iPathNode ) );
  	line+=10;
//      System.out.println( mpp.toCode() );
  ...
  public static void main( String args[] ) throws IOException {
    ...
    String uri = "Skull_and_Crossbones.svg";
    
    SVGMetaPost converter = new SVGMetaPost( SVGMetaPost.class.getResource(uri).toString() );
    converter.run();
  }
}